...
<html>
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>db/migrate/20091230162608_add_expense.rb at master from anjalicg's events - GitHub</title>
...
<script src="https://assets0.github.com/javascripts/bundle_github.js?d5fd66b54f6223e6f6008628f23f8e21d86d7012" type="text/javascript"></script>
  ...
  <link href="https://github.com/anjalicg/events/commits/master.atom" rel="alternate" title="Recent Commits to events:master" type="application/atom+xml" />
    ...
    <script type="text/javascript">
      ...
      GitHub.currentPath = 'db/migrate/20091230162608_add_expense.rb';
...
<div class="flash-messages"></div>
  ...
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="db/migrate/20091230162608_add_expense.rb/">
      <b><a href="/anjalicg/events/tree/015f6b5dd6edba73973a0513944440447a4eb081">events</a></b> / <a href="/anjalicg/events/tree/015f6b5dd6edba73973a0513944440447a4eb081/db">db</a> / <a href="/anjalicg/events/tree/015f6b5dd6edba73973a0513944440447a4eb081/db/migrate">migrate</a> / 20091230162608_add_expense.rb       <span style="display:none" id="clippy_3812">db/migrate/20091230162608_add_expense.rb</span>
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_3812&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="https://assets3.github.com/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_3812&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="db/migrate/20091230162608_add_expense.rb/">
        
          <ul class="big-actions">
            
            <li><a class="file-edit-link minibutton" href="/anjalicg/events/file-edit/__current_ref__/db/migrate/20091230162608_add_expense.rb"><span>Edit this file</span></a></li>
          </ul>
            ...
            <div class="meta">
              <div class="info">
                ...
                <span class="mode" title="File Mode">100644</span>
                  ...
                  <span>15 lines (12 sloc)</span>
                
                <span>0.343 kb</span>
              </div>
              <ul class="actions">
                <li><a href="/anjalicg/events/raw/master/db/migrate/20091230162608_add_expense.rb" id="raw-url">raw</a></li>
                
                  <li><a href="/anjalicg/events/blame/master/db/migrate/20091230162608_add_expense.rb">blame</a></li>
                
                <li><a href="/anjalicg/events/commits/master/db/migrate/20091230162608_add_expense.rb">history</a></li>
              </ul>
            </div>
...
<span id="L15" rel="#L15">15</span>
          ...
          <td width="100%">
                ...
                <div class="highlight"><pre><div class='line' id='LC1'><span class="k">class</span> <span class="nc">AddExpense</span> <span class="o">&lt;</span> <span class="no">ActiveRecord</span><span class="o">::</span><span class="no">Migration</span></div><div class='line' id='LC2'>&nbsp;&nbsp;<span class="k">def</span> <span class="nc">self</span><span class="o">.</span><span class="nf">up</span></div><div class='line' id='LC3'>	<span class="n">add_column</span> <span class="ss">:events</span><span class="p">,</span> <span class="ss">:extra_detail</span><span class="p">,</span> <span class="ss">:text</span></div><div class='line' id='LC4'>	<span class="n">add_column</span> <span class="ss">:users</span><span class="p">,</span> <span class="ss">:mail_fail</span><span class="p">,</span> <span class="ss">:text</span></div><div class='line' id='LC5'>	<span class="n">add_column</span> <span class="ss">:users</span><span class="p">,</span> <span class="ss">:mail_news</span><span class="p">,</span> <span class="ss">:boolean</span></div><div class='line' id='LC6'><span class="c1"># Add in settings to not send mail notification</span></div><div class='line' id='LC7'>	<span class="n">add_column</span> <span class="ss">:users</span><span class="p">,</span> <span class="ss">:login_ip</span><span class="p">,</span> <span class="ss">:text</span></div><div class='line' id='LC8'>	<span class="n">add_column</span> <span class="ss">:users</span><span class="p">,</span> <span class="ss">:accepted_terms</span><span class="p">,</span> <span class="ss">:boolean</span></div><div class='line' id='LC9'><br/></div><div class='line' id='LC10'>&nbsp;&nbsp;<span class="k">end</span></div><div class='line' id='LC11'><br/></div><div class='line' id='LC12'>&nbsp;&nbsp;<span class="k">def</span> <span class="nc">self</span><span class="o">.</span><span class="nf">down</span></div><div class='line' id='LC13'>&nbsp;&nbsp;<span class="k">end</span></div><div class='line' id='LC14'><span class="k">end</span></div><div class='line' id='LC15'><br/></div></pre></div>
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="links">
          ...
          <li><a href="http://support.github.com?sso=tDo2ZZPJ4Kna0w4mIuQnTSI7uQsgvqQ-xeyZxpGed_bWz6mxxBuH3GcmhoHczMEmgcPSSdZ1e5Mel6QEKKS7bHequL4nDeqmidO3VOAltRa6lYj-LS8QEIHyo9Fy6vewNKJO1dZ4s_u1uJ0LudQJCM-3mM2eo7o4eIiQUgTD6Li52QWCqmHljW6GYlyM11iqNlHJ6_Lw8ZJwKgtfj-X4X66l11OfDYYVX-8PyqPaxkYizvHmak1FRHz_vOQPu5WU">Support</a></li>
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.25526s from fe3.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
