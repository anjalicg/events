...
<html>
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>db/migrate/20100114194403_create_wallentries.rb at master from anjalicg's events - GitHub</title>
...
<script src="https://assets0.github.com/javascripts/bundle_github.js?d5fd66b54f6223e6f6008628f23f8e21d86d7012" type="text/javascript"></script>
  ...
  <link href="https://github.com/anjalicg/events/commits/master.atom" rel="alternate" title="Recent Commits to events:master" type="application/atom+xml" />
    ...
    <script type="text/javascript">
      ...
      GitHub.currentPath = 'db/migrate/20100114194403_create_wallentries.rb';
...
<div class="flash-messages"></div>
  ...
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="db/migrate/20100114194403_create_wallentries.rb/">
      <b><a href="/anjalicg/events/tree/015f6b5dd6edba73973a0513944440447a4eb081">events</a></b> / <a href="/anjalicg/events/tree/015f6b5dd6edba73973a0513944440447a4eb081/db">db</a> / <a href="/anjalicg/events/tree/015f6b5dd6edba73973a0513944440447a4eb081/db/migrate">migrate</a> / 20100114194403_create_wallentries.rb       <span style="display:none" id="clippy_1845">db/migrate/20100114194403_create_wallentries.rb</span>
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_1845&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="https://assets3.github.com/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_1845&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="db/migrate/20100114194403_create_wallentries.rb/">
        
          <ul class="big-actions">
            
            <li><a class="file-edit-link minibutton" href="/anjalicg/events/file-edit/__current_ref__/db/migrate/20100114194403_create_wallentries.rb"><span>Edit this file</span></a></li>
          </ul>
        ...
        <div id="files">
          <div class="file">
            <div class="meta">
              ...
              <ul class="actions">
                <li><a href="/anjalicg/events/raw/master/db/migrate/20100114194403_create_wallentries.rb" id="raw-url">raw</a></li>
                
                  <li><a href="/anjalicg/events/blame/master/db/migrate/20100114194403_create_wallentries.rb">blame</a></li>
                
                <li><a href="/anjalicg/events/commits/master/db/migrate/20100114194403_create_wallentries.rb">history</a></li>
              </ul>
            </div>
...
<span id="L16" rel="#L16">16</span>
          ...
          <td width="100%">
                ...
                <div class="highlight"><pre><div class='line' id='LC1'><span class="k">class</span> <span class="nc">CreateWallentries</span> <span class="o">&lt;</span> <span class="no">ActiveRecord</span><span class="o">::</span><span class="no">Migration</span></div><div class='line' id='LC2'>&nbsp;&nbsp;<span class="k">def</span> <span class="nc">self</span><span class="o">.</span><span class="nf">up</span></div><div class='line' id='LC3'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">create_table</span> <span class="ss">:wallentries</span> <span class="k">do</span> <span class="o">|</span><span class="n">t</span><span class="o">|</span></div><div class='line' id='LC4'>	<span class="n">t</span><span class="o">.</span><span class="n">column</span> <span class="ss">:entry_text</span><span class="p">,</span> <span class="ss">:text</span><span class="p">,</span> <span class="ss">:null</span><span class="o">=&gt;</span><span class="kp">false</span></div><div class='line' id='LC5'>	<span class="n">t</span><span class="o">.</span><span class="n">column</span> <span class="ss">:event_id</span><span class="p">,</span> <span class="ss">:integer</span><span class="p">,</span> <span class="ss">:null</span><span class="o">=&gt;</span><span class="kp">false</span></div><div class='line' id='LC6'>	<span class="n">t</span><span class="o">.</span><span class="n">column</span> <span class="ss">:user_id</span><span class="p">,</span> <span class="ss">:integer</span><span class="p">,</span> <span class="ss">:null</span><span class="o">=&gt;</span><span class="kp">false</span></div><div class='line' id='LC7'>	<span class="n">t</span><span class="o">.</span><span class="n">column</span> <span class="ss">:created_at</span><span class="p">,</span> <span class="ss">:timestamp</span></div><div class='line' id='LC8'><br/></div><div class='line' id='LC9'>&nbsp;&nbsp;&nbsp;<span class="k">end</span></div><div class='line' id='LC10'>&nbsp;&nbsp;<span class="k">end</span></div><div class='line' id='LC11'><br/></div><div class='line' id='LC12'>&nbsp;&nbsp;<span class="k">def</span> <span class="nc">self</span><span class="o">.</span><span class="nf">down</span></div><div class='line' id='LC13'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">drop_table</span> <span class="ss">:wallentries</span></div><div class='line' id='LC14'>&nbsp;&nbsp;<span class="k">end</span></div><div class='line' id='LC15'><span class="k">end</span></div><div class='line' id='LC16'><br/></div></pre></div>
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="links">
          ...
          <li><a href="http://support.github.com?sso=tDo2ZZPJ4Kna0w4mIuQnTSI7uQsgvqQ-xeyZxpGed_ay2CcyynT-VyjSqa8tCjXycBDNHuEAzO3wjZRSSsx3KJqXv7YhHo8YbSXTsrnXDg1Quf_8l5K9TerQp77SXJN_kymVUX6iJb7skJ6VrL85UdIFwmJcYliSKsQYCMWE3IOKO5j8JkZfJ4aUVh-KpdOhmDf6p1yeB61KO86tgTZ1tIHKqr3t-rSkyYO_86G58_l18DhAhXw2tH0zYe5MucVv">Support</a></li>
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.13248s from fe6.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
