...
<html>
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>db/migrate/20100108200655_add_reset_code.rb at master from anjalicg's events - GitHub</title>
...
<script src="https://assets0.github.com/javascripts/bundle_github.js?d5fd66b54f6223e6f6008628f23f8e21d86d7012" type="text/javascript"></script>
  ...
  <link href="https://github.com/anjalicg/events/commits/master.atom" rel="alternate" title="Recent Commits to events:master" type="application/atom+xml" />
    ...
    <script type="text/javascript">
      ...
      GitHub.currentPath = 'db/migrate/20100108200655_add_reset_code.rb';
...
<div class="flash-messages"></div>
  ...
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="db/migrate/20100108200655_add_reset_code.rb/">
      <b><a href="/anjalicg/events/tree/015f6b5dd6edba73973a0513944440447a4eb081">events</a></b> / <a href="/anjalicg/events/tree/015f6b5dd6edba73973a0513944440447a4eb081/db">db</a> / <a href="/anjalicg/events/tree/015f6b5dd6edba73973a0513944440447a4eb081/db/migrate">migrate</a> / 20100108200655_add_reset_code.rb       <span style="display:none" id="clippy_1488">db/migrate/20100108200655_add_reset_code.rb</span>
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_1488&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="https://assets3.github.com/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_1488&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="db/migrate/20100108200655_add_reset_code.rb/">
        
          <ul class="big-actions">
            
            <li><a class="file-edit-link minibutton" href="/anjalicg/events/file-edit/__current_ref__/db/migrate/20100108200655_add_reset_code.rb"><span>Edit this file</span></a></li>
          </ul>
        ...
        <div id="files">
          <div class="file">
            <div class="meta">
              ...
              <ul class="actions">
                <li><a href="/anjalicg/events/raw/master/db/migrate/20100108200655_add_reset_code.rb" id="raw-url">raw</a></li>
                
                  <li><a href="/anjalicg/events/blame/master/db/migrate/20100108200655_add_reset_code.rb">blame</a></li>
                
                <li><a href="/anjalicg/events/commits/master/db/migrate/20100108200655_add_reset_code.rb">history</a></li>
              </ul>
            </div>
...
<span id="L9" rel="#L9">9</span>
          ...
          <td width="100%">
                ...
                <div class="highlight"><pre><div class='line' id='LC1'><span class="k">class</span> <span class="nc">AddResetCode</span> <span class="o">&lt;</span> <span class="no">ActiveRecord</span><span class="o">::</span><span class="no">Migration</span></div><div class='line' id='LC2'>&nbsp;&nbsp;<span class="k">def</span> <span class="nc">self</span><span class="o">.</span><span class="nf">up</span></div><div class='line' id='LC3'>	<span class="n">add_column</span> <span class="ss">:users</span><span class="p">,</span> <span class="ss">:reset_code</span><span class="p">,</span> <span class="ss">:string</span></div><div class='line' id='LC4'>&nbsp;&nbsp;<span class="k">end</span></div><div class='line' id='LC5'><br/></div><div class='line' id='LC6'>&nbsp;&nbsp;<span class="k">def</span> <span class="nc">self</span><span class="o">.</span><span class="nf">down</span></div><div class='line' id='LC7'>&nbsp;&nbsp;<span class="k">end</span></div><div class='line' id='LC8'><span class="k">end</span></div><div class='line' id='LC9'><br/></div></pre></div>
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="links">
          ...
          <li><a href="http://support.github.com?sso=tDo2ZZPJ4Kna0w4mIuQnTSI7uQsgvqQ-xeyZxpGed_bWz6mxxBuH3GcmhoHczMEm7RCiH7av6B9ugElSciPKX5CkcwTkqLccMMW5fdqwrpeXv88Z4ZB3DP0RwsHnq_nV11p6GNttrFIZceCYPNu4p_yMz_Z_eztRTHFXShncFuEH8-bigB9fQrkDJKHYd0lfWArKixERuCEqvtyxP656Z-CQl-pyyBDsREASvrHwH0BUkK4-P9M3B8Zvr8Av6Gj2">Support</a></li>
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.11092s from fe3.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
