...
<html>
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>db/migrate/20091122102713_create_sessions.rb at master from anjalicg's events - GitHub</title>
...
<script src="https://assets0.github.com/javascripts/bundle_github.js?d5fd66b54f6223e6f6008628f23f8e21d86d7012" type="text/javascript"></script>
  ...
  <link href="https://github.com/anjalicg/events/commits/master.atom" rel="alternate" title="Recent Commits to events:master" type="application/atom+xml" />
    ...
    <script type="text/javascript">
      ...
      GitHub.currentPath = 'db/migrate/20091122102713_create_sessions.rb';
...
<div class="flash-messages"></div>
  ...
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="db/migrate/20091122102713_create_sessions.rb/">
      <b><a href="/anjalicg/events/tree/015f6b5dd6edba73973a0513944440447a4eb081">events</a></b> / <a href="/anjalicg/events/tree/015f6b5dd6edba73973a0513944440447a4eb081/db">db</a> / <a href="/anjalicg/events/tree/015f6b5dd6edba73973a0513944440447a4eb081/db/migrate">migrate</a> / 20091122102713_create_sessions.rb       <span style="display:none" id="clippy_943">db/migrate/20091122102713_create_sessions.rb</span>
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_943&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="https://assets3.github.com/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_943&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="db/migrate/20091122102713_create_sessions.rb/">
        
          <ul class="big-actions">
            
            <li><a class="file-edit-link minibutton" href="/anjalicg/events/file-edit/__current_ref__/db/migrate/20091122102713_create_sessions.rb"><span>Edit this file</span></a></li>
          </ul>
            ...
            <div class="meta">
              <div class="info">
                ...
                <span class="mode" title="File Mode">100644</span>
                  ...
                  <span>17 lines (14 sloc)</span>
                
                <span>0.317 kb</span>
              </div>
              <ul class="actions">
                <li><a href="/anjalicg/events/raw/master/db/migrate/20091122102713_create_sessions.rb" id="raw-url">raw</a></li>
                
                  <li><a href="/anjalicg/events/blame/master/db/migrate/20091122102713_create_sessions.rb">blame</a></li>
                
                <li><a href="/anjalicg/events/commits/master/db/migrate/20091122102713_create_sessions.rb">history</a></li>
              </ul>
            </div>
...
<span id="L17" rel="#L17">17</span>
          ...
          <td width="100%">
                ...
                <div class="highlight"><pre><div class='line' id='LC1'><span class="k">class</span> <span class="nc">CreateSessions</span> <span class="o">&lt;</span> <span class="no">ActiveRecord</span><span class="o">::</span><span class="no">Migration</span></div><div class='line' id='LC2'>&nbsp;&nbsp;<span class="k">def</span> <span class="nc">self</span><span class="o">.</span><span class="nf">up</span></div><div class='line' id='LC3'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">create_table</span> <span class="ss">:sessions</span> <span class="k">do</span> <span class="o">|</span><span class="n">t</span><span class="o">|</span></div><div class='line' id='LC4'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">t</span><span class="o">.</span><span class="n">string</span> <span class="ss">:session_id</span><span class="p">,</span> <span class="ss">:null</span> <span class="o">=&gt;</span> <span class="kp">false</span></div><div class='line' id='LC5'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">t</span><span class="o">.</span><span class="n">text</span> <span class="ss">:data</span></div><div class='line' id='LC6'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">t</span><span class="o">.</span><span class="n">timestamps</span></div><div class='line' id='LC7'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">end</span></div><div class='line' id='LC8'><br/></div><div class='line' id='LC9'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">add_index</span> <span class="ss">:sessions</span><span class="p">,</span> <span class="ss">:session_id</span></div><div class='line' id='LC10'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">add_index</span> <span class="ss">:sessions</span><span class="p">,</span> <span class="ss">:updated_at</span></div><div class='line' id='LC11'>&nbsp;&nbsp;<span class="k">end</span></div><div class='line' id='LC12'><br/></div><div class='line' id='LC13'>&nbsp;&nbsp;<span class="k">def</span> <span class="nc">self</span><span class="o">.</span><span class="nf">down</span></div><div class='line' id='LC14'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">drop_table</span> <span class="ss">:sessions</span></div><div class='line' id='LC15'>&nbsp;&nbsp;<span class="k">end</span></div><div class='line' id='LC16'><span class="k">end</span></div><div class='line' id='LC17'><br/></div></pre></div>
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="links">
          ...
          <li><a href="http://support.github.com?sso=tDo2ZZPJ4Kna0w4mIuQnTSI7uQsgvqQ-xeyZxpGed_bkD_qerF5xn1AQa-DRBzWamro0ucN0TG8krQjMwQqmtRcON_GzbxHiQrL6kAkvJg2r_Y6PmUvCa3R1cFQR5Skx4mS21wtL8fqtjp3Qu4WhlLNZiGWEyrSOUrC5ru2ETe2XcqnStLRm9-6x3_vOlbYF3BpHBuyx1ESEsasFssc0Ze1ZYOx7EpeQVya1F2saGz4TFQh47d44ykLXzjKMjz2b">Support</a></li>
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.07741s from fe2.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
