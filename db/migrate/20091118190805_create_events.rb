...
<html>
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>db/migrate/20091118190805_create_events.rb at master from anjalicg's events - GitHub</title>
...
<script src="https://assets0.github.com/javascripts/bundle_github.js?d5fd66b54f6223e6f6008628f23f8e21d86d7012" type="text/javascript"></script>
  ...
  <link href="https://github.com/anjalicg/events/commits/master.atom" rel="alternate" title="Recent Commits to events:master" type="application/atom+xml" />
    ...
    <script type="text/javascript">
      ...
      GitHub.currentPath = 'db/migrate/20091118190805_create_events.rb';
...
<div class="flash-messages"></div>
  ...
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="db/migrate/20091118190805_create_events.rb/">
      <b><a href="/anjalicg/events/tree/015f6b5dd6edba73973a0513944440447a4eb081">events</a></b> / <a href="/anjalicg/events/tree/015f6b5dd6edba73973a0513944440447a4eb081/db">db</a> / <a href="/anjalicg/events/tree/015f6b5dd6edba73973a0513944440447a4eb081/db/migrate">migrate</a> / 20091118190805_create_events.rb       <span style="display:none" id="clippy_3965">db/migrate/20091118190805_create_events.rb</span>
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_3965&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="https://assets3.github.com/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_3965&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="db/migrate/20091118190805_create_events.rb/">
        
          <ul class="big-actions">
            
            <li><a class="file-edit-link minibutton" href="/anjalicg/events/file-edit/__current_ref__/db/migrate/20091118190805_create_events.rb"><span>Edit this file</span></a></li>
          </ul>
            ...
            <div class="meta">
              <div class="info">
                ...
                <span class="mode" title="File Mode">100644</span>
                  ...
                  <span>22 lines (20 sloc)</span>
                
                <span>0.502 kb</span>
              </div>
              <ul class="actions">
                <li><a href="/anjalicg/events/raw/master/db/migrate/20091118190805_create_events.rb" id="raw-url">raw</a></li>
                
                  <li><a href="/anjalicg/events/blame/master/db/migrate/20091118190805_create_events.rb">blame</a></li>
                
                <li><a href="/anjalicg/events/commits/master/db/migrate/20091118190805_create_events.rb">history</a></li>
              </ul>
            </div>
...
<span id="L22" rel="#L22">22</span>
          ...
          <td width="100%">
                ...
                <div class="highlight"><pre><div class='line' id='LC1'><span class="k">class</span> <span class="nc">CreateEvents</span> <span class="o">&lt;</span> <span class="no">ActiveRecord</span><span class="o">::</span><span class="no">Migration</span></div><div class='line' id='LC2'>&nbsp;&nbsp;<span class="k">def</span> <span class="nc">self</span><span class="o">.</span><span class="nf">up</span></div><div class='line' id='LC3'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">create_table</span> <span class="ss">:events</span> <span class="k">do</span> <span class="o">|</span><span class="n">t</span><span class="o">|</span></div><div class='line' id='LC4'>	<span class="n">t</span><span class="o">.</span><span class="n">column</span> <span class="ss">:user_id</span><span class="p">,</span> <span class="ss">:integer</span><span class="p">,</span> <span class="ss">:null</span><span class="o">=&gt;</span><span class="kp">false</span></div><div class='line' id='LC5'>	<span class="n">t</span><span class="o">.</span><span class="n">column</span> <span class="ss">:category_id</span><span class="p">,</span> <span class="ss">:integer</span><span class="p">,</span> <span class="ss">:null</span><span class="o">=&gt;</span><span class="kp">false</span></div><div class='line' id='LC6'>	<span class="n">t</span><span class="o">.</span><span class="n">column</span> <span class="ss">:title</span><span class="p">,</span> <span class="ss">:string</span></div><div class='line' id='LC7'>	<span class="n">t</span><span class="o">.</span><span class="n">column</span> <span class="ss">:description</span><span class="p">,</span> <span class="ss">:text</span></div><div class='line' id='LC8'>	<span class="n">t</span><span class="o">.</span><span class="n">column</span> <span class="ss">:location</span><span class="p">,</span> <span class="ss">:string</span></div><div class='line' id='LC9'>	<span class="n">t</span><span class="o">.</span><span class="n">column</span> <span class="ss">:country</span><span class="p">,</span> <span class="ss">:string</span></div><div class='line' id='LC10'>	<span class="n">t</span><span class="o">.</span><span class="n">column</span> <span class="ss">:city</span><span class="p">,</span> <span class="ss">:string</span></div><div class='line' id='LC11'>	<span class="n">t</span><span class="o">.</span><span class="n">column</span> <span class="ss">:time</span><span class="p">,</span> <span class="ss">:timestamp</span></div><div class='line' id='LC12'>	<span class="n">t</span><span class="o">.</span><span class="n">column</span> <span class="ss">:active</span><span class="p">,</span> <span class="ss">:boolean</span></div><div class='line' id='LC13'>	<span class="n">t</span><span class="o">.</span><span class="n">column</span> <span class="ss">:timezone</span><span class="p">,</span> <span class="ss">:string</span></div><div class='line' id='LC14'>	<span class="n">t</span><span class="o">.</span><span class="n">column</span> <span class="ss">:created_at</span><span class="p">,</span> <span class="ss">:timestamp</span></div><div class='line' id='LC15'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">end</span></div><div class='line' id='LC16'>&nbsp;&nbsp;<span class="k">end</span></div><div class='line' id='LC17'><br/></div><div class='line' id='LC18'>&nbsp;&nbsp;<span class="k">def</span> <span class="nc">self</span><span class="o">.</span><span class="nf">down</span></div><div class='line' id='LC19'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">drop_table</span> <span class="ss">:events</span></div><div class='line' id='LC20'>&nbsp;&nbsp;<span class="k">end</span></div><div class='line' id='LC21'><span class="k">end</span></div><div class='line' id='LC22'><br/></div></pre></div>
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="links">
          ...
          <li><a href="http://support.github.com?sso=tDo2ZZPJ4Kna0w4mIuQnTSI7uQsgvqQ-xeyZxpGed_ay2CcyynT-VyjSqa8tCjXytb1HkbhBUknmcgP2uxEY-JYFQc7qoarJwL1jCh7lF0rmrd-c-Ace-pVOTcIGcVoK9Am7LnG_WOmvV2xSGczjuhfD4JArIZMNAFyeZ70inbvOaTW5yRYaxgPtDvtYc-svsWBpXgLlOihHT1G27hsPAjAoO-LL5WEcqb1bZhtumCCNkl3pwNyLPQsWf_UWw-8C">Support</a></li>
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.30595s from fe1.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
