...
#    subject    'JoinmeMailer#newuser: New user account activation'
    ...
    @body=       "Hi, \n Welcome to JoinMe. Click the following link to activate your account and find a companion for your events http://eventzy.heroku.com/user/activate/?newauth=#{code}&email=#{user.email}"
  end
